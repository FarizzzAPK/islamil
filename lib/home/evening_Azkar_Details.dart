...
import 'package:islami_c13_sunday/home/tabs/date_tab/Zekr_details.dart';

class EveningAzkarDetails extends StatefulWidget {
  const EveningAzkarDetails({super.key});

  @override
  State<EveningAzkarDetails> createState() => _EveningAzkarDetailsState();
}

class _EveningAzkarDetailsState extends State<EveningAzkarDetails> {
  @override
              ...
              children: [
                Container(
                  ...
                  child: Padding(
                    ...
                    child: ZekrDetails(
                      zekr:
                      "متنسوش تدعوا لسمر بنت عمي و محمد اسامة ووالد سيف ايمن ووالد بهاء ياسين",
                    ),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.only(top: 8.0, bottom: 8),
                  child: Divider(color: Color(0xffE2BE7F)),
                ),
                ...
                Divider(color: Color(0xffE2BE7F)),
                ZekrDetails(
                ...
                ZekrDetails(
                  zekr:
                  "أَمْسَيْـنا وَأَمْسـى المـلكُ لله وَالحَمدُ لله ، لا إلهَ إلاّ اللّهُ وَحدَهُ لا شَريكَ لهُ، لهُ المُـلكُ ولهُ الحَمْـد، وهُوَ على كلّ شَيءٍ قدير ، رَبِّ أسْـأَلُـكَ خَـيرَ ما في هـذهِ اللَّيْلَةِ وَخَـيرَ ما بَعْـدَهـا ، وَأَعـوذُ بِكَ مِنْ شَـرِّ ما في هـذهِ اللَّيْلَةِ وَشَرِّ ما بَعْـدَهـا، رَبِّ أَعـوذُبِكَ مِنَ الْكَسَـلِ وَسـوءِ الْكِـبَر ، رَبِّ أَعـوذُ بِكَ مِنْ عَـذابٍ في النّـارِ وَعَـذابٍ في القَـبْر",
                ),
                Text(
                  "مرة واحدة",
                  style: TextStyle(color: Colors.white, fontSize: 14),
                ...
                ZekrDetails(
                  zekr:
                  "أَمْسَـينا وَأَمْسـى المُـلكُ للهِ رَبِّ العـالَمـين ، اللّهُـمَّ إِنِّـي أسْـأَلُـكَ خَـيْرَ هـذهِ اللَّيْلَةِ ، فَـتْحَهُ ، وَنَصْـرَهُ ، وَنـورَهُ وَبَـرَكَتَـهُ ، وَهُـداهُ ، وَأَعـوذُ بِـكَ مِـنْ شَـرِّ ما فـيهِ وَشَـرِّ ما بَعْـدَه",
                ),
                Text(
                  "مرة واحدة",
                  style: TextStyle(color: Colors.white, fontSize: 14),
                ...
                Divider(color: Color(0xffE2BE7F)),
                ZekrDetails(
                  zekr: "لأسْتَغْفِرُ اللهَ وَأتُوبُ إلَيْهِ",
                ),
                Text(
                  "مئة مرة",
                  style: TextStyle(color: Colors.white, fontSize: 14),
